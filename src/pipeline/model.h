...
public:
    ...
    // GPU数据上传方法
    void uploadTexture2GPU();
    
    // 获取GPU资源指针
    cudaTextureObject_t getGpuDiffTex() const { return gpuDiffTex; }
    cudaTextureObject_t getGpuNormTex() const { return gpuNormTex; }
    cudaTextureObject_t getGpuSpecTex() const { return gpuSpecTex; }
...
//////////////////////////////////////////////3DV小作业*/
    ...
    // GPU上的纹理资源
    cudaArray_t diffArray = nullptr;
    cudaArray_t normArray = nullptr;
    cudaArray_t specArray = nullptr;
    cudaTextureObject_t gpuDiffTex = 0;
    cudaTextureObject_t gpuNormTex = 0;
    cudaTextureObject_t gpuSpecTex = 0;

    void setupGpuTexture(cudaTextureObject_t& texObj,
